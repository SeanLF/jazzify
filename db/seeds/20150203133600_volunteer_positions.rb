...
medical_volunteer = VolunteerPosition.where(name: "Medical Volunteer").first_or_create do |vp|
  ...
  puts "Created #{vp.name}"
end

beer_tent = VolunteerPosition.where(name: "Beer Tent").first_or_create do |vp|
...
platinum = VolunteerPosition.where(name: "Platinum").first_or_create do |vp|
...
gold_circle_tent = VolunteerPosition.where(name: "Gold Circle Tent").first_or_create do |vp|
...
logistics = VolunteerPosition.where(name: "Logistics").first_or_create do |vp|
...
site_ = VolunteerPosition.where(name: "Site ").first_or_create do |vp|
...
transportation = VolunteerPosition.where(name: "Transportation").first_or_create do |vp|
...
stage = VolunteerPosition.where(name: "Stage").first_or_create do |vp|
...
brookstreet_hotel = VolunteerPosition.where(name: "Brookstreet Hotel").first_or_create do |vp|
...
bbq = VolunteerPosition.where(name: "BBQ").first_or_create do |vp|
  vp.description = "BBQ"
...
media_security = VolunteerPosition.where(name: "Media Security").first_or_create do |vp|
...
souvenirs = VolunteerPosition.where(name: "Souvenirs").first_or_create do |vp|
...
ticket_scanners = VolunteerPosition.where(name: "Ticket Scanners").first_or_create do |vp|
...
rideau_centre = VolunteerPosition.where(name: "Rideau Centre").first_or_create do |vp|
  vp.description = "-"
  vp.objective = ""
  vp.duties = ""
  vp.requirements = ""
  vp.contact_email = "-"
  vp.contact = "-"
  puts "Created #{vp.name} - missing info"
end

office = VolunteerPosition.where(name: "Office").first_or_create do |vp|
  vp.description = "-"
  vp.objective = ""
  vp.duties = ""
  vp.requirements = ""
...
fourth_stage = VolunteerPosition.where(name: "4th Stage").first_or_create do |vp|
...
box_office_evening = VolunteerPosition.where(name: "Box Office Evening").first_or_create do |vp|
...
box_office_daytime = VolunteerPosition.where(name: "Box Office Daytime").first_or_create do |vp|
...
canadian_music_stage_tent = VolunteerPosition.where(name: "Canadian Music Stage Tent").first_or_create do |vp|
...
nac_studio = VolunteerPosition.where(name: "NAC Studio").first_or_create do |vp|
...
park_hospitality_and_communications = VolunteerPosition.where(name: "Park Hospitality & Communications").first_or_create do |vp|
...
vip_tent = VolunteerPosition.where(name: "VIP Tent").first_or_create do |vp|
...
box_office_transition = VolunteerPosition.where(name: "Box Office Transition").first_or_create do |vp|
